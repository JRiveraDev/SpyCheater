        ...
        extends Check
{
    ...
    public LineOfSite(SpyCheater antiCheat)
    {
    ...
    public void Damage(EntityDamageByEntityEvent entityDamageByEntityEvent)
    {
        ...
        if (player2.getLocation().getY() < 0.0) return;
        if (player2.getLocation().getY() > (double) player2.getWorld().getMaxHeight())
        {
            return;
        }
        ...
        Location location2 = UtilPlayer.getEyeLocation(player2);
